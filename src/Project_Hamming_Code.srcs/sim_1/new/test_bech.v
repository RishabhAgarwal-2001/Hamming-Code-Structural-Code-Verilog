`timescale 1ns / 1ps
//////////////////////////////////////////////////////////////////////////////////
// Company: CS203 Project
// Engineer: Rishabh Agarwal(2018CSB1056) & Jigar Nilesh Mehta(2018CSB1155)
// 
// Create Date: 15.10.2019 16:33:18
// Design Name: test_bench
// Module Name: test_bench
// Project Name: Hamming Code
// Target Devices: Communication Devices
// Tool Versions: 1
// Description: Test Bench to check Hamming encoder and decoder function.
// 
// Dependencies: 
// 
// Revision:
...
module test_bench;
    ...
    decoder dec_mod(enc_message_2, decoded_message, var1, var2, var3, var4, var5, op1, op2, op3, op4, op5, op6, op7, op8, op9, op10, op11, op12, op13, op14, op15, op16, op17, op18, op19, op20, op21, op22);
    always begin
